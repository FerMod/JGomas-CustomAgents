...
+!call_for_formation
    <-
      .my_team("ALLIED", E1);
      ?my_position(X, Y, Z);
      .concat("cff(",X, ", ", Y, ", ", Z, ")", Content1);
      .send_msg_with_conversation_id(E1, tell, Content1, "CFF").
/////////////////////////////////
//  GET AGENT TO AIM 
/////////////////////////////////  
/**
...
/////////////////////////////////
//  Initialize variables 150,230
/////////////////////////////////

+!init
   <- ?debug(Mode); if (Mode<=1) { .println("YOUR CODE FOR init GOES HERE.")};
  .my_name(MyName);
  !add_task(task(2500, "TASK_GOTO_POSITION", MyName, pos(23, 0, 241), ""));
  !call_for_formation;
  .wait(6500).